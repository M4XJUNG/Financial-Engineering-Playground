...
| :--- | :--- | :--- |
| **deep-learning-pytorch-textbook** | 파이토치(PyTorch) 기반의 딥러닝 모델 구현 | 《딥러닝 파이토치 교과서》 |
| **doit-pandas** | 판다스를 활용한 데이터 전처리 및 시각화 | 《Do it! 판다스》 |
...
| **release-your-product-with-fastapi** | FastAPI를 활용한 웹 서비스 배포 및 API 구축 | 실무 배포 프로젝트 |
